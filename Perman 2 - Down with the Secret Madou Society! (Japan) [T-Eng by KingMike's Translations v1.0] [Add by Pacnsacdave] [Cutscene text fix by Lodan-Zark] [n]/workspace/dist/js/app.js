...
function startGame() {
    ...
    fetch('roms/Perman 2 - Down with the Secret Madou Society! (Japan) [T-Eng by KingMike\'s Translations v1.0] [Add by Pacnsacdave] [Cutscene text fix by Lodan-Zark] [n].nes')
        .then(response => {
